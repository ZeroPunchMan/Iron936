...
void GPIO_IOMUX_ChangePin(IOMUX_PIN eIOMUX_Pinx, uint32_t IOMUX_FuncPin)
{
  switch (eIOMUX_Pinx)
  {
    case IOMUX_PIN1:   /* for SOP8,TSSOP16, QFN20*/
#if defined (HK32F030xMJxM6)     /* SOP8 */
      GPIOMUX->PKG_PIN_SEL &= IOMUX_PD6_SEL_MASK;//clear select bits(7 8)
      GPIOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
#elif defined (HK32F030xMDxP6)   /* SOP16 */
...
#elif defined (HK32F030xMFxU6) /* QFN20*/
...
#if defined (HK32F030xMDxP6)    /* TSSOP16 */
      if((IOMUX_FuncPin == IOMUX_PD6_SEL_PD6) || (IOMUX_FuncPin == IOMUX_PD6_SEL_PD4))
      {
        GPIOMUX->PKG_PIN_SEL &= IOMUX_PD6_SEL_MASK;//clear select bits(7 8)
        GPIOMUX->PKG_PIN_SEL |= IOMUX_FuncPin;
...
#elif  defined (HK32F030xMFxP6)  /* TSSOP20, TSSOP24, TSSOP28 */
    ...
    case IOMUX_PIN4: /* TSSOP20 */
#if defined (HK32F030xMFxP6)
      if((IOMUX_FuncPin == IOMUX_NRST_SEL_PA0) || (IOMUX_FuncPin == IOMUX_NRST_SEL_NRST))
      {
        GPIOMUX->NRST_PIN_KEY = NRST_PINKEY;
        GPIOMUX->PKG_PIN_SEL &= IOMUX_NRST_SEL_MASK;//clear select bits(0)
    ...
    case IOMUX_PIN9:  /* TSSOP16 */
#if defined (HK32F030xMDxP6)
    ...
    case IOMUX_PIN12: /* TSSOP16*/
#if defined (HK32F030xMDxP6)  /* TSSSOP16 */
