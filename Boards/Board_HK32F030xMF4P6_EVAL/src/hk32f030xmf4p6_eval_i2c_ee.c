/**
  ******************************************************************************
  * @file    hk32f030xmf4p6_eval_i2c_ee.c
  ...
  *          ===================================================================
  *          Notes:
  *           - This driver is intended for HK32F030xMxx families devices only.
  ...
  *          from/to this memory. The needed HK32F030xMxx hardware resources (I2C and
  *          GPIO) are defined in hk32f030xmf4p6_eval.h file, and the initialization is
  *          performed in sEE_LowLevel_Init() function declared in hk32f030xmf4p6_eval.c
  *          file.
...
/* Includes ------------------------------------------------------------------*/
#include "hk32F030xmf4p6_eval_i2c_ee.h"
...
/** @addtogroup HK32F030xMF4P6_EVAL_I2C_EE
  * @brief      This file includes the I2C EEPROM driver of HK32F030xMF4P6-EVAL board.
  * @{
  */
...
/** @defgroup HK32F030xMF4P6_EVAL_I2C_EE_Private_Functions
  * @{
  */
